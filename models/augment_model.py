...
class TransferModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        opt.model = 'skeleton'
        self.skeleton_net = =create_model(opt)
    ...
    def forward_aug(self, input):
        ...
        self.main_model.opt.with_D_PP = 0
   	...
   	def forward_target(self, input):
    	...
    	# get fake_b 
       	...
       	self.main_model.opt.with_D_PB = 1
       	self.main_model.opt.L1_type = 'origin'

 	   	self.skeleton_net.zero_grad()
    ...
    def get_current_visuals(self):
    	aug_pose = util.draw_pose_from_map(self.input_BP_aug)[0]
