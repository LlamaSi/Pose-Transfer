...
class AugmentOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--beta2', type=float, default=0.5, help='momentum term of adam')
        ...
        self.parser.add_argument('--lambda_pose', type=float, default=5.0, help='weight of pose loss')
        ...
        self.parser.add_argument('--L1_type_sk', type=str, default='origin', help='use which kind of L1 loss. (origin|l1_plus_perL1)')
        ...
        self.parser.add_argument('--poseGAN', action='store_true', help='GAN lose for the augment pose')
