...
save_path = '../fashion_data/train_kjson' #path to store pose maps
...
def preprocess_motion2d(motion, mean_pose, std_pose):
    ...
    return np.expand_dims(motion_trans, axis=0)
...
def compute_pose(annotations_file, savePath, sigma=6):
    ...
    for i in tqdm(range(cnt)):
        ...
        input1 = preprocess_motion2d(motion, mean_pose, std_pose)

        np.save(file_name, input1)
